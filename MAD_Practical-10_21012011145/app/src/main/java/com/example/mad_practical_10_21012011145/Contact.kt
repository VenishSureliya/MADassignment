...
class Contact (var id: String, var name: String, var emailID: String, var phoneNum: String, var address: String, var latitude: Double, var longitude: Double):Serializable {
